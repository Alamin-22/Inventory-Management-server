import { LowStockNotificationEmailParams } from './product.email.interface';

const LowStockNotification = (params: LowStockNotificationEmailParams) => {
  const { sku, productTitle, currentQty, threshold, companyName, companyLogoUrl, adminDashboardLink } = params;
          ...
          <table width="600" cellpadding="0" cellspacing="0" style="background-color:#ffffff; border-radius:8px; overflow:hidden; font-family:Arial, sans-serif; border:1px solid #dddddd;">
            ...
            <tr>
              <td style="padding:20px 30px; text-align:center;">
                <h2 style="margin:0; font-size:20px; color:#333333;"> Low Stock Warning</h2>
              </td>
            </tr>
            <tr>
              <td style="padding:0 30px 20px;">
                <p style="margin:0 0 15px 0; font-size:14px; color:#555555; text-align:center;">
                  The following item has dropped below the threshold (${threshold} units):
                </p>
            ...
            <tr>
              <td style="padding:0 30px 20px; text-align:center;">
                <a href="${adminDashboardLink}" style="display:inline-block; padding:12px 24px; font-size:14px; font-weight:600; color:#ffffff; background-color:#f59e0b; border-radius:5px; text-decoration:none;" target="_blank">
                  Manage Inventory
                </a>
              </td>
            </tr>
